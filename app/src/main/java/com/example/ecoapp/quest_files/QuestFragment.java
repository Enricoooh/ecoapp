...
public class QuestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        questList.add(new Quest(0, "Quest A", 50, R.drawable.ic_launcher_background));
        questList.add(new Quest(1, "Quest B", 80, R.drawable.ic_launcher_background));
        questList.add(new Quest(2, "Quest C", 20, R.drawable.ic_launcher_background));

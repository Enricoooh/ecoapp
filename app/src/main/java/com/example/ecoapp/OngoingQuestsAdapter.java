...
import com.example.ecoapp.databinding.ItemQuestOngoingBinding;
import java.util.List;

public class OngoingQuestsAdapter extends RecyclerView.Adapter<OngoingQuestsAdapter.ViewHolder> {
    ...
    public OngoingQuestsAdapter(List<Quest> quests, OnQuestClickListener listener) {
        this.quests = quests;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemQuestOngoingBinding binding = ItemQuestOngoingBinding.inflate(
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        final ItemQuestOngoingBinding binding;
        public ViewHolder(ItemQuestOngoingBinding binding) {
